...
//        << (m_option->Payoff(a_L, path, a_ts)) << std::endl;
        ...
        MCEngine1D<Diffusion1D, AProvider, BProvider, AssetClassA, AssetClassB,
                OHPathEval> m_mce;
        bool m_useTimerSeed; // это фиктивный аргумент, нужен для того6 чтобы                                           настраивать сиды для более аккуретной                                                   генерации экспериментов
